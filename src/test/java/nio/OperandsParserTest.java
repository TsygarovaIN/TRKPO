...
public class OperandsParserTest {
    ...
    private final List<Operand> operands = List.of(op5, op6, op7, op8, op9);
    ...
    public void parseAndCalculateSimple() {
       assertEquals(2, OperandsParser.parseAndCalculate(List.of(op1, op2)), delta);
    }

    @Test
    public void parseAndCalculateBinary() {
        assertEquals(1, OperandsParser.parseAndCalculate(List.of(op3, op4)), delta);
    }

    @Test
    public void parseAndCalculateNonEquals() {
        assertEquals(Double.NaN, OperandsParser.parseAndCalculate(List.of(op1, op3)), delta);
    }
    ...
    public void parseAndCalculateExp() {
        assertEquals(2.71828, OperandsParser.parseAndCalculate(List.of(op10)), delta);
    }

    @Test
    public void parseAndCalculateLn() {
        assertEquals(2.302585, OperandsParser.parseAndCalculate(List.of(op11)), delta);
    }

    @Test
    public void parseAndCalculateEmpty() {
        assertEquals(Double.NaN, OperandsParser.parseAndCalculate(List.of(op12)), delta);
    }

    @Test
    public void parseAndCalculateABS() {
        assertEquals(3, OperandsParser.parseAndCalculate(List.of(op9)), delta);
    }

    @Test
    public void parseAndCalculateTAN() {
        assertEquals(1.55741, OperandsParser.parseAndCalculate(List.of(op13)), delta);
    }

    @Test
    public void parseAndCalculateDivide0() {
        assertEquals(Double.POSITIVE_INFINITY, OperandsParser.parseAndCalculate(List.of(op14, op15)), delta);
    }

    @Test
    public void parseAndCalculateMult0() {
        assertEquals(0, OperandsParser.parseAndCalculate(List.of(op16, op15)), delta);
    }

    @Test
    public void parseAndCalculateSinPi() {
        assertEquals(0, OperandsParser.parseAndCalculate(List.of(op17)), delta);
    }

    @Test
    public void parseAndCalculateCosPi() {
        assertEquals(-1, OperandsParser.parseAndCalculate(List.of(op18)), delta);
    }

    @Test
    public void parseAndCalculateABSPi() {
        assertEquals(Math.PI, OperandsParser.parseAndCalculate(List.of(op19)), delta);
    }
